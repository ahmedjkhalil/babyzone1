...
class Camera10 extends StatefulWidget {
  const Camera10({Key? key}) : super(key: key);

  @override
  State<Camera10> createState() => _Camera10State();
}
...
class _Camera10State extends State<Camera10> {
  @override
  void initState() {
...
class CamerUi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final VlcPlayerController _videoPlayerController1 =
        VlcPlayerController.network(cameraui["cameraID10"]["url"],
