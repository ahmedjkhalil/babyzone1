...
class Camera14 extends StatefulWidget {
  const Camera14({Key? key}) : super(key: key);

  @override
  State<Camera14> createState() => _Camera14State();
}
...
class _Camera14State extends State<Camera14> {
  @override
  void initState() {
...
class CamerUi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final VlcPlayerController _videoPlayerController1 =
        VlcPlayerController.network(cameraui["cameraID14"]["url"],
