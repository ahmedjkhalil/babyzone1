...
class Camera13 extends StatefulWidget {
  const Camera13({Key? key}) : super(key: key);

  @override
  State<Camera13> createState() => _Camera13State();
}
...
class _Camera13State extends State<Camera13> {
  @override
  void initState() {
...
class CamerUi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final VlcPlayerController _videoPlayerController1 =
        VlcPlayerController.network(cameraui["cameraID13"]["url"],
