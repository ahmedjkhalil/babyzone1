...
class Camera15 extends StatefulWidget {
  const Camera15({Key? key}) : super(key: key);

  @override
  State<Camera15> createState() => _Camera15State();
}
...
class _Camera15State extends State<Camera15> {
  @override
  void initState() {
...
class CamerUi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final VlcPlayerController _videoPlayerController1 =
        VlcPlayerController.network(cameraui["cameraID15"]["url"],
