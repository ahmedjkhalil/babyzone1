...
class Camera12 extends StatefulWidget {
  const Camera12({Key? key}) : super(key: key);

  @override
  State<Camera12> createState() => _Camera12State();
}
...
class _Camera12State extends State<Camera12> {
  @override
  void initState() {
...
class CamerUi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final VlcPlayerController _videoPlayerController1 =
        VlcPlayerController.network(cameraui["cameraID12"]["url"],
