...
class Camera16 extends StatefulWidget {
  const Camera16({Key? key}) : super(key: key);

  @override
  State<Camera16> createState() => _Camera16State();
}
...
class _Camera16State extends State<Camera16> {
  @override
  void initState() {
...
class CamerUi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final VlcPlayerController _videoPlayerController1 =
        VlcPlayerController.network(cameraui["cameraID16"]["url"],
