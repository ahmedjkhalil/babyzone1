...
class Camera11 extends StatefulWidget {
  const Camera11({Key? key}) : super(key: key);

  @override
  State<Camera11> createState() => _Camera11State();
}
...
class _Camera11State extends State<Camera11> {
  @override
  void initState() {
...
class CamerUi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final VlcPlayerController _videoPlayerController1 =
        VlcPlayerController.network(cameraui["cameraID11"]["url"],
