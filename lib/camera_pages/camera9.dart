...
class Camera9 extends StatefulWidget {
  const Camera9({Key? key}) : super(key: key);

  @override
  State<Camera9> createState() => _Camera9State();
}
...
class _Camera9State extends State<Camera9> {
  @override
  void initState() {
...
class CamerUi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final VlcPlayerController _videoPlayerController1 =
        VlcPlayerController.network(cameraui["cameraID9"]["url"],
